      ...
      {isOpen && (
        <div className="absolute inset-0 z-50 flex items-center justify-center">
          ...
          >
            ...
            <button
              onClick={onConfirm}
              className="w-[220px] py-4 bg-white text-black font-semibold text-[17px] rounded-full mb-4 active:scale-95 transition-transform shadow-lg"
            >
              Delete
            </button>
            ...
            <button
              onClick={onCancel}
              className="text-white/80 text-[17px] py-2 active:opacity-60 transition-opacity"
            >
              Cancel
            </button>
          </motion.div>
